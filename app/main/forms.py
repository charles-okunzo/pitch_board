...
class PitchForm(FlaskForm):
  ...
  category = SelectField('Category:', choices=[('Pickup lines, Pickup lines'), ('Technology, Technology'), ('Innovation', 'Innovation'), ('Promotion', 'Promotion')], validators=[DataRequired()])
